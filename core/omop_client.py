            ...
            try:
                with conn:
                    ...
                    COPY (
                        ...
                        FROM read_csv('{vocab_path}CONCEPT.csv') c1
                        LEFT JOIN read_csv('{vocab_path}CONCEPT_RELATIONSHIP.csv') cr on c1.concept_id = cr.concept_id_1
                        LEFT JOIN read_csv('{vocab_path}CONCEPT.csv') c2 on cr.concept_id_2 = c2.concept_id
