 ...
 TRY_CAST(COALESCE(COALESCE(vh_value_as_concept_id, 0), '0') AS BIGINT) AS value_as_concept_id,
 TRY_CAST(COALESCE(NULL, '0') AS BIGINT) AS qualifier_concept_id,
 TRY_CAST(COALESCE(NULL, '0') AS BIGINT) AS unit_concept_id,
 ...
 TRY_CAST(COALESCE(condition_source_concept_id, '0') AS BIGINT) AS observation_source_concept_id,
 ...
 TRY_CAST(COALESCE(NULL, '0') AS BIGINT) AS obs_event_field_concept_id
