        ...
        SELECT
            CAST(COALESCE(hash(CONCAT(CAST(condition_occurrence_id AS VARCHAR),CAST(person_id AS VARCHAR),'test_site')) % 9223372036854775807, '-1') AS BIGINT) AS observation_id,
