                ...
                COPY (
                    ...
                    LEFT JOIN read_parquet('gs://vocab-bucket/v5.0_24-JAN-25/optimized/concept_relationship.parquet') cr on c1.concept_id = cr.concept_id_1
                    ...
                    WHERE IFNULL(cr.relationship_id, '')
                        IN ('', 'Maps to','Maps to value','Maps to unit','Concept replaced by','Concept was_a to','Concept poss_eq to','Concept same_as to','Concept alt_to to')
